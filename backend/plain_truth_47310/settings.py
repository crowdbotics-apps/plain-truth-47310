"""
Django settings for plain_truth_47310 project.
...
ROOT_URLCONF = 'plain_truth_47310.urls'
...
WSGI_APPLICATION = 'plain_truth_47310.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "plain_truth_47310 API",
    "DESCRIPTION": "API documentation for plain_truth_47310 App",
    "VERSION": "v1",
}
